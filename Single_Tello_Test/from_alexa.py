...
myMQTTClient.configureCredentials('rootCA.pem', 'fef0460c44-private.pem.key', 'fef0460c44-certificate.pem.crt')
...
myMQTTClient.subscribe("test/pub", 1, customCallback)
while True:
    time.sleep(1)
